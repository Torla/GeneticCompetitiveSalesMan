...
void Population::nextGeneration() {
	...
	rouletteWheel(parentsCouples);

	for(register unsigned int i=1;i<parentsCouples.size()-pop.size()*steadyRatio;i+=2){ // todo opt steady ratio
...
void Population::rouletteWheel(std::vector<Chromosome *> & parentCouples) {
